...
save = True
inputs = 'data/f1_{}.npy'
name = 'mirror_at_each_element_tests/trace_through_system/files_npy/f1_0'
image_loc = 0 #0,1,2,3,4 or something else
...
camera = {
  ...
  #  'angles': np.array([Conv(90), Conv(90), Conv(90)]),
    ...
    'X': np.array([[-1100. + 2*M4['f'] -20., 6522., 0.]]),
    'angles': np.array([Conv(90), Conv(90), 0.])
}
image_beam = {
...
image_m4f = {
    'R': 10_000.,
    'name': 'ImagePlane',
    'X': np.array([[-1100. + 10. +  2*M4['f'], 6522., 0.]]),
    'yrot': True,
    'angles': np.array([0., Conv(-90), 0.])
}
